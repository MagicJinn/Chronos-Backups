...
|--------------|---------------|---------------------------------------------------------------------|--------|--------------|----------------------------------------------------------------------------------------------------------------------------------------|
| `26.x`       | ✅ Supported   | Fabric + NeoForge + Bukkit, Spigot, Paper, Purpur and Folia         | ✅      | 🟠 File-only | Fabric: 26.1–26.3. NeoForge: through 26.2 (26.3 pending). Paper plugin: 26.1.1+ only. Folia: 26.1.2 only.                            |
