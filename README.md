...
|--------------|---------------|---------------------------------------------------------------------|--------|--------------|----------------------------------------------------------------------------------------------------------------------------------------|
| `26.x`       | ✅ Supported   | Fabric + NeoForge + Bukkit, Spigot, Paper, Purpur and Folia         | ✅      | 🟠 File-only | Fabric: 26.1–26.3. NeoForge: 26.1–26.3 (compile pin `26.3.0.1-beta`). Paper plugin: 26.1.1+ (26.3 via experimental channel). Folia: 26.1.2, 26.2 (experimental). Bukkit/Spigot: through 26.2, not 26.3 yet. |
